...
<div><label>제목</label><input type="text" name="title" value="빅데이터 분석 운용" readonly></div>
<div><label>출판사</label><input type="text" name="pub" value="도서출판 신림" readonly></div>
<div><label>가격</label><input type="text" name="price" value="29000" readonly></div>
<div><label>출판일</label><input type="text" name="pubdate" value="2022-06-02" readonly></div>
<div><label>저자</label><input type="text" name="author" value="김용용" readonly></div>
